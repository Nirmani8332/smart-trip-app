          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Welcome back, Earl's Regency Hotel</p>
              </div>
            </div>
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 min-h-screen sticky top-16 self-start">
          <nav className="p-4 space-y-1">
            <a href="#" className="flex items-center gap-3 px-4 py-3 bg-purple-50 text-purple-600 rounded-lg font-medium">
            ...
            <div className="pt-4 border-t border-gray-200">
              <a href="#" className="flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 rounded-lg">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="metric-card bg-white rounded-xl shadow-md p-6">
              ...
              <p className="text-xs text-gray-500 mt-1">Feb 2025</p>
            </div>
