          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-body">AI Travel Planning</p>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-8 font-body">
              ...
              <a href="#destinations" className="text-gray-700 hover:text-purple-600 font-medium transition-colors">Destinations</a>
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="px-5 py-2.5 text-gray-700 font-semibold hover:text-purple-600 transition-colors font-body"
              >
                Sign In
              </button>
              <button 
      ...
      <section className="relative pt-32 pb-20 px-6 lg:px-8 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 rounded-full border border-purple-200">
                ...
                <span className="text-sm font-semibold text-purple-600 font-body">🔥 10,000+ trips planned this month</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button className="px-8 py-4 bg-white border-2 border-gray-200 text-gray-700 font-bold rounded-2xl hover:border-purple-300 hover:shadow-lg transition-all text-lg font-body flex items-center gap-2">
              ...
              <div className="flex items-center gap-8 pt-4">
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-700 font-body">4.9/5 from 2,400+ reviews</p>
                </div>
                <div className="h-12 w-px bg-gray-300"></div>
                <div>
                  <p className="text-2xl font-bold text-gray-900 font-heading">500+</p>
                  <p className="text-sm text-gray-600 font-body">Destinations</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative float">
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 font-heading">Plan Your Trip</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 font-body">📍 Destination</label>
                    <select className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:bg-white outline-none transition-all font-body">
                      <option>Kandy</option>
                      <option>Galle</option>
                      <option>Ella</option>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2 font-body">💰 Budget</label>
                      <input 
                        type="text" 
                        placeholder="LKR 100,000"
                        className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:bg-white outline-none transition-all font-body"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-2 font-body">👥 Travelers</label>
                      <input 
                        type="text" 
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2 font-body">📅 Travel Dates</label>
                    <input 
                      type="text" 
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex items-center justify-between text-sm font-body">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-gray-900">AI Planning Engine</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="features" className="py-20 px-6 lg:px-8 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 font-body">Everything you need for the perfect trip</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <div 
                  key={index}
                  className="group bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 card-hover"
                >
        ...
        <section id="how-it-works" className="py-20 px-6 lg:px-8 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 font-body">From idea to itinerary in minutes</p>
            </div>
                ...
                <div key={index} className="flex gap-8 items-start">
                  ...
                  <div className="flex-1 pt-4">
                    <div className="flex items-center gap-4 mb-3">
                      <span className="text-6xl font-black text-gray-100 font-heading">{step.num}</span>
                      <h3 className="text-3xl font-bold text-gray-900 font-heading">{step.title}</h3>
                    </div>
                    <p className="text-lg text-gray-600 leading-relaxed font-body">{step.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section id="destinations" className="py-20 px-6 lg:px-8 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 font-body">Handpicked experiences across Sri Lanka</p>
            </div>
              ...
              {destinations.map((dest, index) => (
                ...
                >
                  ...
                  <div className="relative p-8 h-96 flex flex-col justify-end">
                    <div className="mb-4">
                      <span className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-bold mb-4 font-body">
                        {dest.tagline}
                      </span>
                      <h3 className="text-4xl font-bold mb-3 font-heading">{dest.name}</h3>
                      <p className="text-lg text-gray-200 mb-6 font-body">{dest.description}</p>
                    </div>

                    <div className="flex flex-wrap gap-2 mb-6">
                      {dest.highlights.map((highlight, idx) => (
                        <span key={idx} className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-lg text-sm font-body">
                          ✓ {highlight}
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-300 font-body">{dest.days} Days Package</p>
                      </div>
                      <button 
                        onClick={() => setShowSignupModal(true)}
                        className="px-6 py-3 bg-white text-gray-900 font-bold rounded-xl hover:bg-gray-100 transition-all font-body"
                      >
                        Explore →
                      </button>
                    </div>
            ...
            <div className="text-center">
              <button className="px-8 py-4 border-2 border-white/30 text-white font-bold rounded-2xl hover:bg-white/10 transition-all font-body">
        ...
        <section className="py-20 px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 font-body">Real stories from real adventurers</p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="bg-white rounded-3xl p-6 shadow-lg border border-gray-100 card-hover">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 font-body">{testimonial.name}</h4>
                      <p className="text-xs text-gray-600 font-body">{testimonial.role}</p>
                    </div>
                  </div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed font-body">{testimonial.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-6 lg:px-8 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 font-body">We've got answers</p>
            </div>
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span className="font-bold text-gray-900 text-lg font-heading pr-4">{faq.question}</span>
                  ...
                  {expandedFaq === index && (
                    <div className="px-8 pb-6">
                      <p className="text-gray-700 leading-relaxed font-body">{faq.answer}</p>
                    </div>
                  )}
                </div>
              ))}
            ...
            <div className="text-center mt-12">
              <p className="text-gray-600 mb-4 font-body">Need more help?</p>
        ...
        <section className="py-20 px-6 lg:px-8 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              <button 
                onClick={() => setShowSignupModal(true)}
                className="px-12 py-5 bg-white text-purple-600 font-bold rounded-2xl hover:shadow-2xl transition-all text-xl font-body"
              >
                Start Planning for Free
              </button>
              <button className="px-12 py-5 bg-white/10 backdrop-blur-sm border-2 border-white text-white font-bold rounded-2xl hover:bg-white/20 transition-all text-xl font-body">
                Schedule a Demo
              </button>
            </div>
        ...
        <footer className="bg-gray-900 text-white py-16 px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
              <div className="lg:col-span-2">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-body">AI Travel Planning</p>
                  </div>
                </div>
              ...
              <div>
                              ...
                              <ul className="space-y-3 text-gray-400 font-body">
                                ...
                                <li><Link to="/vendor/register" className="hover:text-white transition-colors">Vendor Registration</Link></li>
                              </ul>
                            </div>
              <div>
            ...
            <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
              <p className="text-gray-400 text-sm font-body">&copy; 2025 SmartTRIP. All rights reserved.</p>
        ...
        {showLoginModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2 font-body">Email Address</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2 font-body">Password</label>
                  <input
                    type="password"
                    placeholder="••••••••"
                    className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:bg-white outline-none transition-all font-body"
        ...
        {showSignupModal && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-bold text-gray-900 font-heading">Get Started Free</h2>
                <button 
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2 font-body">Full Name</label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <input
                    type="email"
                    placeholder="you@example.com"
                    className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:bg-white outline-all font-body"
                  />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2 font-body">Password</label>
                ...
                <label className="flex items-start gap-2 text-sm font-body">
                  ...
                  <span className="text-gray-700">
                    I agree to the{' '}
                    <a href="#" className="text-purple-600 hover:text-purple-700 font-bold">Terms</a>
                    {' '}
                    and{' '}
                    <a href="#" className="text-purple-600 hover:text-purple-700 font-bold">Privacy Policy</a>
                  </span>
                </label>
                <button className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:shadow-xl transition-all font-body">
                  Create Account
